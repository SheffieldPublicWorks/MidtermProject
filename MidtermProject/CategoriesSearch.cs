...
namespace MidtermProject
{
    ...
    {
        public static int SearchMethod(ArrayList menu)
        {
            ...
            if (option == "1" || option == "christmas")
            {
                ...
                int selection = Validator.GetValidSelection1();//Make sure the number is on the list
            ...
            else if (option == "2" || option == "valentines")
            {
                ...
                int selection = Validator.GetValidSelection2();//Make sure the number is on the list
                int newSelection = selection - 1;
            }
            else if (option == "3" || option == "thanksgiving")
            {
                ...
                int selection = Validator.GetValidSelection3();//Make sure the number is on the list
                int newSelection = selection - 1;
            }
            else if (option == "4" || option == "fourthofjuly")
            {
                ...
                int selection = Validator.GetValidSelection4();//Make sure the number is on the list
                int newSelection = selection - 1;
            }
